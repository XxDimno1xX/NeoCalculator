...
#ifdef HAVE_UNISTD_H
#include <unistd.h>
#if !defined(NSPIRE) && !defined FXCG && !defined(__VISUALC__) && !defined(NUMWORKS) && !defined TICE// #ifndef NSPIRE
#include <dirent.h>
#ifndef __MINGW_H
#include <pwd.h>
#endif // MINGW
...
#if defined FXCG || defined TICE || defined NSPIRE_NEWLIB
...
#if 0 // !defined GIAC_HAS_STO_38 && !defined FXCG && !defined TICE
